...
function (_super) {
  ...
  function Flicking(element, options) {
    ...
    _this.resize = function () {
      ...
      var shouldResetElements = options.renderOnlyVisible && !options.isConstantSize && options.isEqualSize !== true;
