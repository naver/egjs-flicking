...
(function (global, factory) {
    ...
    */
    ...
    var Flicking = /*#__PURE__*/function (_super) {
       ...
       * ```
       */
      Flicking.VERSION = "4.13.1-snapshot";
      return Flicking;
    }(Component);
    ...
    var flickingReactiveAPIAdapter = function (_a) {
      ...
      var reactiveObj = reactive({
        isReachStart: (options === null || options === void 0 ? void 0 : options.defaultIndex) === 0 && !options.circular,
        isReachEnd: false,
        totalPanelCount: 0,
        currentPanelIndex: (_b = options === null || options === void 0 ? void 0 : options.defaultIndex) !== null && _b !== void 0 ? _b : 0,
        progress: 0,
        indexProgress: 0,
        moveTo: moveTo
      });
