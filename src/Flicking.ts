...
class Flicking extends Component {
   ...
   * @param {boolean} [options.collectStatistics=true] Whether to collect statistics on how you are using `Flicking` around the world. <ko>전 세계에서 어떻게 `Flicking`을 사용하고 있는지에 대한 통계 수집 여부.</ko>
   */
  constructor(
