import Flicking from "../../packages/react-flicking/dist/flicking.esm.js";
import CFCTabs from "../src/component/CFCTabs"
import Columns from "../src/component/Columns";
import ColumnItem from "../src/component/ColumnItem";
import AutoInit from "../src/demo/AutoInit";
...
## defaultIndex
Index of the panel to move when Flicking's [init](api/Flicking.mdx#init) is called.
...
<Columns>
  ...
  <ColumnItem is={6} className="has-text-centered">
    <Flicking className="flicking-viewport vertical" horizontal={false}>
      <div className="flicking-panel has-background-primary has-text-white is-size-1">1</div>
      <div className="flicking-panel has-background-primary has-text-white is-size-1">2</div>
      <div className="flicking-panel has-background-primary has-text-white is-size-1">3</div>
    </Flicking>
...
## needPanelThreshold
A Threshold from viewport edge before triggering [needPanel](api/Flicking.mdx#event-needPanel) event
