...
**Returns**: boolean
- A Boolean value indicating the element is inside of this panel {@link Panel#element element}
...
|includeMargin|boolean|yes|false|Include [margin](margin) to the range|
