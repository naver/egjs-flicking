...
|:---:|:---:|:---:|
|panel|[Constants.ALIGN](Constants:ALIGN) \| string \| number|The align value for each [Panel](Panel)s|
|camera|[Constants.ALIGN](Constants:ALIGN) \| string \| number|The align value for [Camera](Camera)|
...
|PARAMETER|TYPE|OPTIONAL|DEFAULT|DESCRIPTION|
|:---:|:---:|:---:|:---:|:---:|
|status||no||Status value to be restored. You can specify the return value of the [getStatus()](Flicking#getStatus) method|
...
|PARAMETER|TYPE|OPTIONAL|DEFAULT|DESCRIPTION|
|:---:|:---:|:---:|:---:|:---:|
|plugins|Plugin \| Plugin[]|no||The plugin(s) to remove.|
...
|direction|[Constants.DIRECTION](Constants:DIRECTION)|Moving direction relative to previous position of the camera|
...
|isTrusted|boolean|Boolean that indicates whether the event was generated by a user action|
|direction|[Constants.DIRECTION](Constants:DIRECTION)|Moving direction from the active panel to the target panel|
...
|direction|[Constants.DIRECTION](Constants:DIRECTION)|Direction from current camera position to the selected panel's position|
