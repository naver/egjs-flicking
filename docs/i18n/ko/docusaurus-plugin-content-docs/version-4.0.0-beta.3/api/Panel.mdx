...
|options.align|[Constants.ALIGN](Constants:ALIGN) \| string \| number|yes||패널의 초기 [align](Flicking#align)값|
...
현재 패널의 위치 오프셋 값. [circular](Flicking#circular) 모드에서 패널의 엘리먼트의 순서가 변경될 때 이 값이 변경됩니다
