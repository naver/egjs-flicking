...
|options.align|[Constants.ALIGN](Constants:ALIGN) \| string \| number|yes||전체 패널에 적용될 [align](Flicking#align) 값|
|options.elementManipulator|[OffsetManipulator](OffsetManipulator)|yes||Renderer가 사용할 [OffsetManipulator](OffsetManipulator)의 인스턴스|
