...
**Returns**: [AnchorPoint](AnchorPoint) \| null
- The {@link AnchorPoint} that includes the given position
...
**Returns**: [AnchorPoint](AnchorPoint) \| null
- The {@link AnchorPoint} nearest to the given position
