...
|options.align|[Constants.ALIGN](Constants:ALIGN) \| string \| number|yes||An [align](Flicking#align) value that will be applied to all panels|
|options.elementManipulator|[OffsetManipulator](OffsetManipulator)|yes||An instance of [OffsetManipulator](OffsetManipulator) that renderer will use|
