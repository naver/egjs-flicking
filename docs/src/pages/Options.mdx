...
<Columns>
  ...
  <ColumnItem is={6}>
    <Flicking preventClickOnDrag={true}>
      <a href="https://naver.com" className="panel-with-link"><div className="flicking-panel has-background-primary has-text-white is-size-1">1</div></a>
      <a href="https://naver.com" className="panel-with-link"><div className="flicking-panel has-background-primary has-text-white is-size-1">2</div></a>
      <a href="https://naver.com" className="panel-with-link"><div className="flicking-panel has-background-primary has-text-white is-size-1">3</div></a>
      <a href="https://naver.com" className="panel-with-link"><div className="flicking-panel has-background-primary has-text-white is-size-1">4</div></a>
      <a href="https://naver.com" className="panel-with-link"><div className="flicking-panel has-background-primary has-text-white is-size-1">5</div></a>
    </Flicking>
  </ColumnItem>
</Columns>
<Columns>
...
### disableOnInit
Automatically call [disableInput()](api/Flicking#disableInput) on initialization
...
:::info
Hint: See panel element's style in the developer console
:::
