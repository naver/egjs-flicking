...
You can check this by **[circularEnabled](api/Flicking#circularEnabled)** property of Flicking.
...
This will change instance type of **[Flicking#control](api/Flicking#control)**
You can use the values of the constant **[MOVE_TYPE](api/MOVE_TYPE)**

If an array is given, second value of the array will be used as the options object when creating **[Control](api/Control)**

|moveType|control|options|
|---|---|---|
|"snap" (MOVE_TYPE.SNAP)|**[SnapControl](api/SnapControl)**||
|"freeScroll" (MOVE_TYPE.FREE_SCROLL)|**[FreeControl](api/FreeControl)**|**[FreeControlOptions](api/FreeControlOptions)**|
...
<Columns>
  ...
  <ColumnItem is={6}>
    <Flicking preventClickOnDrag={true}>
      <a href="https://naver.com" className="panel-with-link"><Panel index={0} /></a>
      <a href="https://naver.com" className="panel-with-link"><Panel index={1} /></a>
      <a href="https://naver.com" className="panel-with-link"><Panel index={2} /></a>
      <a href="https://naver.com" className="panel-with-link"><Panel index={3} /></a>
      <a href="https://naver.com" className="panel-with-link"><Panel index={4} /></a>
    </Flicking>
  </ColumnItem>
</Columns>
<Columns>
