...
<Columns>
  ...
  <ColumnItem is={6}>
    <Flicking resizeOnContentsReady={true} preventDefaultOnDrag={false}>
      <div style={{ maxWidth: "100%" }}><img style={{ maxWidth: "100%" }} src={require("@site/static/img/demo/bg01.jpg").default} /></div>
      <div style={{ maxWidth: "100%" }}><img style={{ maxWidth: "100%" }} src={require("@site/static/img/demo/bg02.jpg").default} /></div>
      <div style={{ maxWidth: "100%" }}><img style={{ maxWidth: "100%" }} src={require("@site/static/img/demo/bg03.jpg").default} /></div>
    </Flicking>
...
<Columns>
  ...
  <ColumnItem is={6}>
    <Flicking resizeOnContentsReady={true} preventDefaultOnDrag={true}>
      <div style={{ maxWidth: "100%" }}><img style={{ maxWidth: "100%" }} src={require("@site/static/img/demo/bg01.jpg").default} /></div>
      <div style={{ maxWidth: "100%" }}><img style={{ maxWidth: "100%" }} src={require("@site/static/img/demo/bg02.jpg").default} /></div>
      <div style={{ maxWidth: "100%" }}><img style={{ maxWidth: "100%" }} src={require("@site/static/img/demo/bg03.jpg").default} /></div>
    </Flicking>
...
This can prevent `willRestore` from being called on continuous swipe when using `circular: true`.
...
<Columns>
  ...
  <ColumnItem is={6}>
    <EventFlicking changeOnHold={false} circular={true} moveType="strict" events={["changed", "willChange", "restored", "willRestore"]}>
      { Panels(5) }
    </EventFlicking>
  </ColumnItem>
</Columns>
<Columns>
  ...
  <ColumnItem is={6}>
    <EventFlicking changeOnHold={true} circular={true} moveType="strict" events={["changed", "willChange", "restored", "willRestore"]}>
      { Panels(5) }
    </EventFlicking>
  </ColumnItem>
</Columns>
...
<Columns>
  <ColumnItem is={12}>
    <Flicking useFractionalSize={false} defaultIndex={2} style={{ width: "200px" }}>
      <div className="has-background-primary" style={{ width: "199.5px", height: "200px" }}></div>
      <div className="has-background-info" style={{ width: "199.5px", height: "200px" }}></div>
      <div className="has-background-success" style={{ width: "199.5px", height: "200px" }}></div>
      <div className="has-background-danger" style={{ width: "199.5px", height: "200px" }}></div>
      <div className="has-background-warning" style={{ width: "199.5px", height: "200px" }}></div>
    </Flicking>
  </ColumnItem>
</Columns>
<Columns>
