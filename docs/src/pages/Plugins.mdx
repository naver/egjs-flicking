...
import PerspectiveDemo from "@site/src/demo/plugins/Perspective";
...
|renderActiveBullet|function \| null|✔️|null|A render function for the active(selected) bullet, effective for "bullet" and "scroll" type.<br/>If `null` is given, `renderBullet` will be used instead.|
...
|synchronizedFlickingOptions[].flicking|[Flicking](docs/api/Flicking)|||An instance of Flicking to sync|
