...
export default () => <>
  <Flicking className="has-background-grey-lighter p-4 mb-4" moveType="freeScroll" bound={true}>
  ...
  <SourceCode options={{ moveType: "freeScroll", bound: true }} panels={[
    { tag: "span", class: "button mr-2 is-white", content: "🍎 Apple" },
    { tag: "span", class: "button mr-2 is-white", content: "🍉 Watermelon" },
    { tag: "span", class: "button mr-2 is-white", content: "🥝 Kiwi" },
    { tag: "span", class: "button mr-2 is-white", content: "..." }
  ]} />
</>;
