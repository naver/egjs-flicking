...
class El {
  ...
  public static DEFAULT_HORIZONTAL_WITH_PANELS(n: number) {
    return El.viewport("1000px", "100%").add(
      El.camera().add(...range(n).map(() => El.panel().setWidth("100%").setHeight(300)))
    );
  }
  ...
  public static get DEFAULT_VERTICAL() {
    return El.viewport("1000px", "1000px")
      .addClass(EL_CLASS.VERTICAL)
      .add(
        El.camera().add(
  ...
  public static get EMPTY() {
    return El.viewport("1000px", "1000px").add(El.camera());
  }
