...
:::caution
If you are using an external React Component, you should use [`forwardedRef`](/docs/quick-start).
:::
...
### Pagination
> You can synchronize Flicking with Pagination using <Link to={useBaseUrl("docs/api/FlickingReactiveState")}>currentPanelIndex</Link> and <Link to={useBaseUrl("docs/api/FlickingReactiveState")}>totalPanelCount</Link>.
...
### Prev / Next Button
> You can synchronize Flicking with Prev/Next buttons using <Link to={useBaseUrl("docs/api/FlickingReactiveState")}>isReachStart</Link> and <Link to={useBaseUrl("docs/api/FlickingReactiveState")}>isReachEnd</Link>.
...
### Progress Bar
> You can synchronize Flicking with Progress Bar using <Link to={useBaseUrl("docs/api/FlickingReactiveState")}>progress</Link>.
...
### Parallax
> You can create a Parallax effect for each panel using <Link to={useBaseUrl("docs/api/FlickingReactiveState")}>indexProgress</Link>.
...
### Slide Over
> You can create a Slide Over effect using <Link to={useBaseUrl("docs/api/FlickingReactiveState")}>indexProgress</Link>.
...
### Cover flow
> You can create a Cover flow UI using <Link to={useBaseUrl("docs/api/FlickingReactiveState")}>indexProgress</Link>.
