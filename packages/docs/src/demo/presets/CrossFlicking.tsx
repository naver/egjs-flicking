...
export default () => {
      ...
      panels: [
        {
          ...
          image: "https://cdn.pixabay.com/photo/2022/01/17/01/19/cherry-blossoms-6943659_1280.jpg"
        },
        {
          title: "Tulips, Daffodils, Flowers",
          image: "https://cdn.pixabay.com/photo/2016/02/13/10/35/tulips-1197602_1280.jpg"
        },
        {
          title: "Lin zhi, Tibet, Snow mountain",
          image: "https://cdn.pixabay.com/photo/2022/04/23/07/38/lin-zhi-7151302_1280.jpg"
        },
        {
          title: "Flowers, Beautiful flowers, Spring",
          image: "https://cdn.pixabay.com/photo/2015/03/26/11/06/flowers-692433_1280.jpg"
        },
        {
          title: "Spring, Flowering tree, Flower",
          image: "https://cdn.pixabay.com/photo/2019/05/06/19/20/spring-4183996_1280.jpg"
        }
      ]
    },
    {
      ...
      panels: [
        {
          ...
          image: "https://cdn.pixabay.com/photo/2023/03/28/19/54/mountains-7884039_1280.jpg"
        },
        {
          title: "Beach, Sea, Island",
          image: "https://cdn.pixabay.com/photo/2021/08/01/12/58/beach-6514331_1280.jpg"
        },
        {
          title: "Vineyards, Nature, Vines",
          image: "https://cdn.pixabay.com/photo/2019/07/14/10/48/vineyards-4336787_1280.jpg"
        },
        {
          title: "Field, Sunflowers, Tree",
          image: "https://cdn.pixabay.com/photo/2020/07/06/06/57/field-5375784_1280.jpg"
        },
        {
          title: "Sea, Lighthouse, Horizon",
          image: "https://cdn.pixabay.com/photo/2022/09/11/09/26/sea-7446433_1280.jpg"
        }
      ]
    },
    {
      ...
      panels: [
        {
          ...
          image: "https://cdn.pixabay.com/photo/2021/11/22/16/46/nature-6816877_1280.jpg"
        },
        {
          title: "Path, Trees, Autumn",
          image: "https://cdn.pixabay.com/photo/2019/10/31/06/58/path-4591121_960_720.jpg"
        },
        {
          title: "Maple leaves, Autumn, Leaves",
          image: "https://cdn.pixabay.com/photo/2017/09/26/16/32/maple-leaves-2789234_1280.jpg"
        },
        {
          title: "Forest, Nature, Autumn",
          image: "https://cdn.pixabay.com/photo/2019/10/19/13/00/forest-4561344_1280.jpg"
        }
      ]
    },
    {
      ...
      panels: [
        {
          title: "Snowy landscape, Winter",
          image: "https://cdn.pixabay.com/photo/2016/11/13/13/47/snowy-landscape-1821037_1280.jpg"
        },
        {
          title: "Winter, Hochybrig, Pre-alps",
          image: "https://cdn.pixabay.com/photo/2019/12/15/18/24/winter-4697776_1280.jpg"
        },
        {
          title: "Road, Forest, Snow",
          image: "https://cdn.pixabay.com/photo/2021/01/09/20/23/road-5903402_1280.jpg"
        },
        {
          title: "Winter forest, Conifer, Snow",
          image: "https://cdn.pixabay.com/photo/2022/12/14/10/33/winter-forest-7655125_1280.jpg"
        },
        {
          title: "Snow, Mountain, Winter",
          image: "https://cdn.pixabay.com/photo/2018/04/09/16/24/snow-3304547_1280.jpg"
        }
      ]
    }
  ];
  ...
  const onMove = e => {
    const next =
      (e.currentTarget.index as number) + (e.currentTarget.visiblePanels[0].index === e.currentTarget.index ? 1 : -1);
  ...
  return (
    <div className="demo">
      <div className="labels">
        ...
        {groups.map((item, i) => (
          <div className="tab" ref={el => (tabRef.current[i] = el)} key={i}>
            <a className={"label " + (index === i ? "" : "")} onClick={() => onTabClick(i)}>
              {item.name}
            </a>
          </div>
        ))}
      ...
      <div className="page">
        {pagination[index] < panelCount && pagination[index] >= 0 ? (
          Array.from({ length: panelCount }).map((_, i) => {
            return (
              <span key={i} className={`dot ${i === pagination[index] ? "on" : ""}`}>
                {i + 1}
              </span>
            );
          })
