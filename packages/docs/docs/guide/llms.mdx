...
slug: /guide/llms
sidebar_position: 5
description: Use Flicking's llms.txt with AI tools for more accurate code generation
keywords: [flicking, llms.txt, ai, llm, cursor, claude code, copilot, documentation]
---
