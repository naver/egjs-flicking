...
sidebar_position: 4
description: Vue3-specific features, event handlers, and component usage for using Flicking
keywords: [flicking, vue3, composition api, ref, components]
---
...
:::info
This guide is for Vue3 users. For React, see the [React Guide](./react-guide). For vanilla JavaScript, see the [Quick Start](./quickstart) guide.
:::
