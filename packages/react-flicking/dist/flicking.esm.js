...
function (_super) {
  ...
  __proto.render = function () {
    ...
    return createElement(Tag, __assign({}, attributes), createElement("div", {
  ...
  __proto.componentDidMount = function () {
    ...
    this.flicking = new NativeFlicking(findDOMNode(this), options);
    var flicking = this.flicking;
...
export { DIRECTION_LEFT, DIRECTION_RIGHT, DIRECTION_TOP, DIRECTION_BOTTOM };
